...
//                m2.invoke(ntf, aContext, TO_SEARCH,
//                        "", null);
//            } catch (Exception e) {
...
//    private static final Class<?>[] STOP_FG_SIG = new Class[]{boolean.class};
    ...
    public void onServiceCreate() {
        try {
            mStartForeground = context.getClass().getMethod("startForeground", int.class,Notification.class);
            mStopForeground = context.getClass().getMethod("stopForeground", boolean.class);
        ...
        try {
            mSetForeground = context.getClass().getMethod("setForeground", boolean.class);
        } catch (NoSuchMethodException e) {
