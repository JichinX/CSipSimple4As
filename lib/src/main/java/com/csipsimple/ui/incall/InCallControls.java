...
public class InCallControls extends FrameLayout {
    ...
    private final ActionMenuView menuView;
...
//        btnMenuBuilder.setCallback(this);
        menuView = new ActionMenuView(getContext());
        MenuInflater inflater = new MenuInflater(getContext());
        inflater.inflate(R.menu.in_call_controls_menu, menuView.getMenu());
...
//
    ...
    public void setMediaState(MediaState mediaState) {
        ...
        Menu btnMenuBuilder = menuView.getMenu();
